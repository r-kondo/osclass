                ...
                <fieldset>
                    ...
                    <p id="password-error" style="display:none;">
                       ...
                       <?php osc_show_recaptcha('register'); ?>
                        ...
                        <div class="form-group">
                        <label><input class="cekk" type="checkbox" required=""><?php _e("I agree to the", 'royal'); ?> <a target="_blank" href="<?php echo osc_get_preference('tos-me', 'paris'); ?>"><?php _e("Terms of Use", 'royal'); ?></a></label>
                        </div>
