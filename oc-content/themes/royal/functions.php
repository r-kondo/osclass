<?php
    ...
    define('ROYAL_THEME_VERSION', '1.4.5');
...
function royal_add_google_fonts(){
	echo "<link href='http://fonts.googleapis.com/css?family=".royal_google_fonts()."' rel='stylesheet' type='text/css'>";
    ...
    function theme_royal_actions_admin() {
        ...
        switch( Params::getParam('action_specific') ) {
            case('settings'):
                $rtl_view	=	Params::getParam('rtl_view', 'royal_theme');
                ...
                osc_set_preference('rtl_view', ($rtl_view ? '1' : '0'), 'royal_theme');
                ...
                osc_set_preference('fb-us',         trim(Params::getParam('fb-us', false, false, false)),                  'royal');
                osc_set_preference('wl-us',         trim(Params::getParam('wl-us', false, false, false)),                  'royal');
                osc_set_preference('avatar-royal',         trim(Params::getParam('avatar-royal', false, false, false)),                  'royal');
...
if( !function_exists('royal_item_title') ) {
    ...
    if( !function_exists('royal_theme_install') ) {
        function royal_theme_install() {
            ...
            osc_set_preference('version', '1.4.5', 'royal');
            ...
            osc_set_preference('copyright-royal', 'Copyright 2015 Osclass.me', 'royal');
            osc_set_preference('premiumads_num_royal', '8', 'royal');
            osc_set_preference('rtl_view', '0', 'royal_theme');
...
osc_remove_preference('fb-us', 'royal');
osc_remove_preference('wl-us', 'royal'); 
osc_remove_preference('avatar-royal', 'royal'); 
