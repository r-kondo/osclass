                ...
                <div id="general">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-row">
                            <div class="form-label">
                                <?php _e('RTL', 'royal'); ?>
                                <?php _e('view', 'royal'); ?> </div>
                            <div class="form-controls">
                                <div class="form-label-checkbox">
                                    <input type="checkbox" name="rtl_view" value="1" <?php echo (osc_esc_html( osc_get_preference('rtl_view', 'royal_theme') )=="1" )? "checked": ""; ?>> </div>
                                <br/>
                                <div class="help-box">
                                    <?php _e('only for arabic or persian language.', 'royal'); ?> </div>
                            </div>
                        </div>
                    </div>
                </div>
 ...
 <div class="form-row">
                ...
                <div id="plugins">
                    ...
                    <div class="form-row">
                            ...
                            <div class="form-controls">
                                <div class="form-label-checkbox">
                                    <input type="checkbox" name="sect77_view" value="1" <?php echo (osc_esc_html( osc_get_preference( 'sect77_view', 'royal_theme') )=="1" )? "checked": ""; ?>>
                                    <br/>
                                    <div class="help-box">
                                        <p>
                                            <a style="color:red;">
                                                <?php _e('Warning', 'royal'); ?> </a>
                                            <?php _e('you must install phone plugin, before activate this features', 'royal'); ?><br><a style="color:blue;" href="http://market.osclass.org/plugins/attributes/telephone-plugin_507" target="_blank">http://market.osclass.org/plugins/attributes/telephone-plugin_507</a> </p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-label"><b><?php _e('Madhouse Avatar (display)', 'royal'); ?></b> </div>
                            <div class="form-controls">
                                <?php $avatar_royal=osc_esc_html( osc_get_preference('avatar-royal', 'royal') ); ?>
                                <select name="avatar-royal">
                                    <option value="yes" <?php if($avatar_royal=='yes' ){ echo 'selected="selected"' ; } ?>>
                                        <?php _e('Yes', 'royal'); ?> </option>
                                    <option value="no" <?php if($avatar_royal=='no' ){ echo 'selected="selected"' ; } ?>>
                            ...
                            <div class="form-controls">
                                <p>
                                    <a style="color:red;">
                                        <?php _e('Warning', 'royal'); ?> </a>
                                    <?php _e('you must install madhouse avatar plugin, before activate madhouse avatar', 'royal'); ?> <br><?php _e('Download here <a target="_blank" href="http://market.osclass.org/plugins/user-management/madhouse-avatar_187" style="color:blue;">http://market.osclass.org/plugins/user-management/madhouse-avatar_187</a>', 'royal'); ?> </p>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-label"><b><?php _e('HybridAuth (display)', 'royal'); ?></b> </div>
                            <div class="form-controls">
                                <?php $fb_royal=osc_esc_html( osc_get_preference('fb-us', 'royal') ); ?>
                                <select name="fb-us">
                                    <option value="yes" <?php if($fb_royal=='yes' ){ echo 'selected="selected"' ; } ?>>
                                        <?php _e('Yes', 'royal'); ?> </option>
                                    <option value="none" <?php if($fb_royal=='none' ){ echo 'selected="selected"' ; } ?>>
                                        <?php _e('No', 'royal'); ?> </option>
                                </select>
                            </div>
                            <div class="form-controls">
                                <p>
                                    <a style="color:red;">
                                        <?php _e('Warning', 'royal'); ?> </a>
                                    <?php _e('you must install HybridAuth  plugin, before activate', 'royal'); ?><br><?php _e('Download here <a target="_blank" href="http://market.osclass.org/plugins/social-networks/hybridauth_336" style="color:blue;">http://market.osclass.org/plugins/social-networks/hybridauth_336</a>', 'royal'); ?>  </p>
                            </div>
                        </div>
                    </div>
                </div>                                                         
...
<div class="form-actions">
    ...
    <div class="power">
        <p><?php _e('Royal', 'royal'); ?> <?php _e('version', 'royal'); ?> <?php _e('1.4.5', 'royal'); ?> | <?php _e('by', 'royal'); ?>
