...
<div class="power"><p><?php _e('Royal', 'royal'); ?> <?php _e('version', 'royal'); ?> <?php _e('1.4.5', 'royal'); ?> | <?php _e('by', 'royal'); ?> <a title="<?php echo osc_esc_html(__('Royal','royal')); ?> <?php echo osc_esc_html(__('Themes Powered by OsclassDotMe','royal')); ?>" target="_blank" href="http://market.osclass.org/user/profile/2614"><?php _e('Osclass.Me', 'royal'); ?></a></p></div>