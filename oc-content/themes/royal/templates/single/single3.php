    ...
    <div id="content">
        <div id="main" class="col-md-12">
            <div class="col-md-6">
                ...
                <div class="col-md-12 row panel panel-body"> <img id="zoom_03" src="<?php echo osc_resource_thumbnail_url(); ?>" data-zoom-image="<?php echo osc_resource_url(); ?>" />
                    <div id="gallery_01">
                        <?php for ( $i=0 ; osc_has_item_resources(); $i++ ) { ?> <a href="#" class="gallery_01 " data-image="<?php echo osc_resource_thumbnail_url(); ?>" data-zoom-image="<?php echo osc_resource_url(); ?>"> <img src="<?php echo osc_resource_thumbnail_url(); ?>" /> </a>
                        <?php } ?> </div>
                </div>
                <?php } else { ?>
                        ...
                        <div style="padding:10px" class="modal-content">
                            <p class="contact_button">
                                ...
                                <div id="contact">
                                    ...
                                    <?php } ?>
                                    <?php if(osc_get_preference('sect77_view', 'royal_theme')=="1" ) { ?>
